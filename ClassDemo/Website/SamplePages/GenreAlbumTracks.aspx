...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <!-- 
        Inside a repeater you need a minimum of one ItemTemplate other templates include HeaderTemple, FooterTemplate, AlternatingItemTemplate, SeperatorTemplate
        ...
        Nested Repeater will display the collection of the previous DTO repeater.
        ...
        <ItemTemplate>
            ...
            <asp:Repeater ID="AlbumTrackList" runat="server" DataSource='<%# Eval("albums") %>' ItemType="Chinook.Data.DTOs.AlbumDTO">
                <ItemTemplate>
                    ...
                    <asp:ListView ID="TrackList" runat="server" ItemType="Chinook.Data.POCOs.TrackPOCO" DataSource="<%# Item.tracks %>">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label2" runat="server" Text="<%# Item.length %>" Width="600px"></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <AlternatingItemTemplate>
                            <tr style="background-color:aqua">
                                ...
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text="<%# Item.length %>" Width="600px"></asp:Label>
                                </td>
                            </tr>
                        </AlternatingItemTemplate>
                        <EmptyDataTemplate>
                    ...
                    <%--GridView --%>
                    <%--<asp:GridView ID="TrackList" runat="server" ItemType="Chinook.Data.POCOs.TrackPOCO" DataSource="<%# Item.tracks %>" AutoGenerateColumns="False">
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Song">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label1" runat="server" Text="<%# Item.song %>" Width="600px">
                                    </asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Length">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text="<%# Item.length %>" Width="600px">
                                    </asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <%--Nested Repeater
                        <asp:Repeater ID="TrackList" runat="server" ItemType="Chinook.Data.POCOs.TrackPOCO" DataSource="<%# Item.tracks %>">
                        <HeaderTemplate>
                            <table>
                                <tr>
                                    <th>Song</th>
    ...
    <asp:ObjectDataSource ID="GenreAlbumTrackListODS" runat="server"></asp:ObjectDataSource>
</asp:Content>
