     ...
     <div class="row">
        <div class="col-md-12">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="listviewcrud">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <asp:ListView ID="ListViewCRUD" runat="server" DataSourceID="ListViewCRUDODS" DataKeyName="AlbumID">
                                ...
                                <AlternatingItemTemplate>
                                    <tr style="background-color: #FFF8DC;">
                                        ...
                                        <td align="center">
                                            <asp:Label Text='<%# Eval("Rel. Year") %>' runat="server" ID="ReleaseYearLabel" Width="50px" /></td>
                                        <td>
                                            <asp:Label Text='<%# Eval("Rel. Label") %>' runat="server" ID="ReleaseLabelLabel" /></td>
                                        <td>
                                ...
                                <EditItemTemplate>
                                    <tr style="background-color: #008A8C; color: #FFFFFF;">
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="RadioButtonList1" runat="server" SelectedValue=''</asp:RadioButtonList>
                                            <asp:TextBox Text='<%# Bind("ArtistId") %>' runat="server" ID="ArtistIdTextBox" /></td>
                                        <td align="center">
                                            <asp:TextBox Text='<%# Bind("Rel. Year") %>' runat="server" ID="ReleaseYearTextBox" Width="50px" /></td>
                                        <td>
                                            <asp:TextBox Text='<%# Bind("Rel. Label") %>' runat="server" ID="ReleaseLabelTextBox" /></td>
                                        <td>
                            ...
                            <asp:ObjectDataSource ID="ListViewCRUDODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Album_ListByYearRelease" TypeName="ChinookSystem.BLL.AlbumController">

                                <SelectParameters>
                                    <asp:Parameter Name="minyear" Type="Int32"></asp:Parameter>
                                    <asp:Parameter Name="maxyear" Type="Int32"></asp:Parameter>
                                </SelectParameters>
                            </asp:ObjectDataSource>
                        </ContentTemplate>
                    </asp:UpdatePanel>
         ...
         <%-- some people will collect all ODS controls and place them in a single location for easy access.
             the ODS controls are not associated with a soecific tab but instead the entire page. --%>
    </div>
</asp:Content>
